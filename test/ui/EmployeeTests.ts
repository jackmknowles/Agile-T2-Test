...
import { getSingleEmployee } from '../../src/services/EmployeeService';
...
describe('Employee test', async () => {
    ...
    */
    ...
    describe('Employee test', async () => {
    it('Should not create an employee with a salary less than £20,000', async () => {
        const driver = new webdriver.Builder().
            withCapabilities(webdriver.Capabilities.chrome()).
            build();

        const url = process.env.UI_TEST_URL || 'http://localhost:3000/';
        await driver.get(url);
    ...
    */
    ...
    describe('Employee test', async () => {
        it('Should show the name of the employee matching the clicked name', async () => {
            const driver = new webdriver.Builder().
                withCapabilities(webdriver.Capabilities.chrome()).
                build();
